...
public class TableController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle){
        ...
        try(BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Professional\\IdeaProjects\\young\\src\\main\\resources\\backpack.txt"))){
            String line;
    ...
    public void getSelected() throws Exception{
        ...
        String tag = Dop.getTag(Dop.getRow(item));

        WebEngine webEngine = webView.getEngine();
        webEngine.load(String.format("https://smart-lab.ru/q/%s/f/y/", tag));
    }
}
