...
public class EnterController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        imageView.setImage(new Image(String.format("C:\\Users\\Professional\\IdeaProjects\\young\\src\\main\\resources\\picture\\%s.png", tag)));
    }

    public void add(){
        String name = label.getText();
        try(BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\Professional\\IdeaProjects\\young\\src\\main\\resources\\backpack.txt", true))){
